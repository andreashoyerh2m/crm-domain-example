...
public interface DataSupplierIf
{
    ...
    /**
     * Every implementation must be able to return the object id. The id is used to compare domain objects.
     * 
     * @return The id.
     */
    ...
    /**
     * Sets the domain object that is associated with the data interface implementation. Should be used to mark a domain object as deleted (for
     * testing/debugging purposes).
     * 
     * @param domainObject The domain object that is associated with the interface implementation.
     */
