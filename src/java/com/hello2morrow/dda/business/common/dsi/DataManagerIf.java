...
{
    /**
     * Every manager implementation must be able to create a data supplier for a 'new' domain object.
     * 
     ...
     */
    public abstract DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent) throws TechnicalException;

    /**
     * Every manager implementation must be able to delete a given data supplier. This may result in the deletion of other data suppliers.
     * 
    ...
    /**
     * Every persistence manager implementation must be able to create a data supplier for a specified object id.
     * 
     * @param id.
