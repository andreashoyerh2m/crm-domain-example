...
public final class AddressDtoMapper
{
    ...
    public static com.hello2morrow.ddaexample.business.contact.service.AddressDto[] createDtosFromDomainObjects(
            com.hello2morrow.ddaexample.business.contact.domain.Address[] domainObjects) throws TechnicalException
    {
    ...
    public static com.hello2morrow.ddaexample.business.contact.service.AddressDto createDtoFromDomainObject(
            com.hello2morrow.ddaexample.business.contact.domain.Address domainObject) throws TechnicalException
    {
    ...
    public static void mapDtoToDomainObject(com.hello2morrow.ddaexample.business.contact.service.AddressDto dto,
            com.hello2morrow.ddaexample.business.contact.domain.Address domainObject, boolean resolveReferences)
