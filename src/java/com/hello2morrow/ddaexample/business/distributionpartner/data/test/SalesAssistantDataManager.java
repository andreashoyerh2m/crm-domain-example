...
public class SalesAssistantDataManager extends com.hello2morrow.ddaexample.business.contact.data.test.PersonDataManager
        implements com.hello2morrow.ddaexample.business.distributionpartner.dsi.SalesAssistantDmi
{
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert SalesAssistantDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
    ...
    public com.hello2morrow.ddaexample.business.distributionpartner.dsi.SalesAssistantDsi[] findSalesAssistantByFirstNameAndLastName(
            java.lang.String firstName, java.lang.String lastName) throws com.hello2morrow.dda.foundation.common.exception.TechnicalException
    {
        ...
        return (com.hello2morrow.ddaexample.business.distributionpartner.dsi.SalesAssistantDsi[]) found
                .toArray(new com.hello2morrow.ddaexample.business.distributionpartner.dsi.SalesAssistantDsi[0]);
    }
}