...
public class RequestForInformationDataManager extends com.hello2morrow.ddaexample.business.request.data.test.RequestDataManager
        implements com.hello2morrow.ddaexample.business.distributionpartner.dsi.RequestForInformationDmi
{
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert RequestForInformationDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
