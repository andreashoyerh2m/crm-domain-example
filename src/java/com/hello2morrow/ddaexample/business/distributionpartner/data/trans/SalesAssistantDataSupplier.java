        ...
        implements SalesAssistantDsi
{
    ...
    {
        return (com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[]) m_Customers
    ...
    protected void mapContentTo(DataSupplierIf persistent) throws BusinessException, TechnicalException
    {
        ...
        for (int i = 0; i < customers.length; ++i)
        {
            ...
            {
                mapped[i] = (com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi) ((com.hello2morrow.dda.business.common.dsi.TransientDataSupplier) nextFromCustomers)
                        .save();
            }
            else
            {
