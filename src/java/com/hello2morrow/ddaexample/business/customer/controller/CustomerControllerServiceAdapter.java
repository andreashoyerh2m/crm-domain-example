...
{
    private final static Logger s_Logger = LogManager.getLogger(CustomerControllerServiceAdapter.class);
    ...
    public com.hello2morrow.dda.foundation.common.ObjectIdIf createCustomer(com.hello2morrow.ddaexample.business.user.service.ContextDto contextDto,
            com.hello2morrow.ddaexample.business.customer.service.CustomerDto customerDto,
    ...
    public com.hello2morrow.dda.foundation.common.ObjectIdIf createVipCustomer(
            com.hello2morrow.ddaexample.business.user.service.ContextDto contextDto,
            com.hello2morrow.ddaexample.business.customer.service.VipCustomerDto customerDto,
            com.hello2morrow.ddaexample.business.contact.service.AddressDto addressDto) throws BusinessException, TechnicalException
    {
    ...
    public com.hello2morrow.ddaexample.business.customer.service.CustomerDto[] retrieveCustomers(
