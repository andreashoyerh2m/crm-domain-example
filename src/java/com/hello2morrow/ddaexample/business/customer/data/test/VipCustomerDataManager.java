...
public class VipCustomerDataManager extends com.hello2morrow.ddaexample.business.customer.data.test.CustomerDataManager
        implements com.hello2morrow.ddaexample.business.customer.dsi.VipCustomerDmi
{
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert VipCustomerDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
    ...
    public com.hello2morrow.ddaexample.business.customer.dsi.VipCustomerDsi[] findVipCustomerByFirstNameAndLastName(java.lang.String firstName,
            java.lang.String lastName) throws com.hello2morrow.dda.foundation.common.exception.TechnicalException
    {
        ...
        return (com.hello2morrow.ddaexample.business.customer.dsi.VipCustomerDsi[]) found
                .toArray(new com.hello2morrow.ddaexample.business.customer.dsi.VipCustomerDsi[0]);
    }
}