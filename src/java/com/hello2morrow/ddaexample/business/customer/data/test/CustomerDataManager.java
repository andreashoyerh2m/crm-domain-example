...
public class CustomerDataManager extends com.hello2morrow.ddaexample.business.contact.data.test.PersonDataManager
        implements com.hello2morrow.ddaexample.business.customer.dsi.CustomerDmi
{
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert CustomerDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
    ...
    public com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[] findAllCustomers()
    {
        ...
        return (com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[]) specific
                .toArray(new com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[0]);
    }

    public com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[] findCustomerByFirstNameAndLastName(java.lang.String firstName,
            java.lang.String lastName) throws com.hello2morrow.dda.foundation.common.exception.TechnicalException
    {
        ...
        for (int i = 0; i < all.length; i++)
        {
            ...
            if (next instanceof com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi)
            {
                ...
                if (casted.getFirstName().equals(firstName) && casted.getLastName().equals(lastName))
                {
                    found.add(casted);
                }
            }
        ...
        return (com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[]) found
                .toArray(new com.hello2morrow.ddaexample.business.customer.dsi.CustomerDsi[0]);
    }
}