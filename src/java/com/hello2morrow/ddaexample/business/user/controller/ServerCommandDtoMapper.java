...
public final class ServerCommandDtoMapper
{
    ...
    public static com.hello2morrow.ddaexample.business.user.service.ServerCommandDto[] createDtosFromDomainObjects(
            com.hello2morrow.ddaexample.business.user.domain.ServerCommand[] domainObjects) throws TechnicalException
    {
    ...
    public static com.hello2morrow.ddaexample.business.user.service.ServerCommandDto createDtoFromDomainObject(
            com.hello2morrow.ddaexample.business.user.domain.ServerCommand domainObject) throws TechnicalException
    {
    ...
    public static void mapDtoToDomainObject(com.hello2morrow.ddaexample.business.user.service.ServerCommandDto dto,
            com.hello2morrow.ddaexample.business.user.domain.ServerCommand domainObject, boolean resolveReferences)
