...
public final class UserDtoMapper
{
    ...
    public static com.hello2morrow.ddaexample.business.user.service.UserDto[] createDtosFromDomainObjects(
            com.hello2morrow.ddaexample.business.user.domain.User[] domainObjects) throws TechnicalException
    {
    ...
    public static com.hello2morrow.ddaexample.business.user.service.UserDto createDtoFromDomainObject(
            com.hello2morrow.ddaexample.business.user.domain.User domainObject) throws TechnicalException
    {
    ...
    public static void mapDtoToDomainObject(com.hello2morrow.ddaexample.business.user.service.UserDto dto,
            com.hello2morrow.ddaexample.business.user.domain.User domainObject, boolean resolveReferences)
            throws BusinessException, TechnicalException
    {
        ...
        if (resolveReferences)
        {
            ...
            {
                resolved[i] = (com.hello2morrow.ddaexample.business.user.domain.Role) com.hello2morrow.dda.business.common.dsi.DomainObjectWithDataSupplier
