...
public final class RoleDtoMapper
{
    ...
    public static com.hello2morrow.ddaexample.business.user.service.RoleDto[] createDtosFromDomainObjects(
            com.hello2morrow.ddaexample.business.user.domain.Role[] domainObjects) throws TechnicalException
    {
    ...
    public static com.hello2morrow.ddaexample.business.user.service.RoleDto createDtoFromDomainObject(
            com.hello2morrow.ddaexample.business.user.domain.Role domainObject) throws TechnicalException
    {
    ...
    public static void mapDtoToDomainObject(com.hello2morrow.ddaexample.business.user.service.RoleDto dto,
            com.hello2morrow.ddaexample.business.user.domain.Role domainObject, boolean resolveReferences)
            throws BusinessException, TechnicalException
    {
        ...
        if (resolveReferences)
        {
            ...
            {
                resolved[i] = (com.hello2morrow.ddaexample.business.user.domain.ServerCommand) com.hello2morrow.dda.business.common.dsi.DomainObjectWithDataSupplier
