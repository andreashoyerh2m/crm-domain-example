...
public final class LoginEventDtoMapper
{
    ...
    public static com.hello2morrow.ddaexample.business.user.service.LoginEventDto[] createDtosFromDomainObjects(
            com.hello2morrow.ddaexample.business.user.domain.LoginEvent[] domainObjects) throws TechnicalException
    {
    ...
    public static com.hello2morrow.ddaexample.business.user.service.LoginEventDto createDtoFromDomainObject(
            com.hello2morrow.ddaexample.business.user.domain.LoginEvent domainObject) throws TechnicalException
    {
    ...
    public static void mapDtoToDomainObject(com.hello2morrow.ddaexample.business.user.service.LoginEventDto dto,
            com.hello2morrow.ddaexample.business.user.domain.LoginEvent domainObject, boolean resolveReferences)
