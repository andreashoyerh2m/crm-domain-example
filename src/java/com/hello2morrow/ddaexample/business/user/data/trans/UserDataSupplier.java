...
public class UserDataSupplier extends com.hello2morrow.dda.business.common.dsi.TransientDataSupplier implements UserDsi
{
    ...
    {
        return (com.hello2morrow.ddaexample.business.user.dsi.RoleDsi[]) m_Roles
                .toArray(new com.hello2morrow.ddaexample.business.user.dsi.RoleDsi[0]);
    }
    ...
    protected void mapContentTo(DataSupplierIf persistent) throws BusinessException, TechnicalException
    {
        ...
        for (int i = 0; i < roles.length; ++i)
        {
            ...
            {
                mapped[i] = (com.hello2morrow.ddaexample.business.user.dsi.RoleDsi) ((com.hello2morrow.dda.business.common.dsi.TransientDataSupplier) nextFromRoles)
                        .save();
            }
            else
            {
