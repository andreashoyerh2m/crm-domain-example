...
public class RoleDataSupplier extends com.hello2morrow.dda.business.common.dsi.TransientDataSupplier implements RoleDsi
{
    ...
    {
        return (com.hello2morrow.ddaexample.business.user.dsi.ServerCommandDsi[]) m_ServerCommands
                .toArray(new com.hello2morrow.ddaexample.business.user.dsi.ServerCommandDsi[0]);
    }
    ...
    protected void mapContentTo(DataSupplierIf persistent) throws BusinessException, TechnicalException
    {
        ...
        for (int i = 0; i < serverCommands.length; ++i)
        {
            ...
            {
                mapped[i] = (com.hello2morrow.ddaexample.business.user.dsi.ServerCommandDsi) ((com.hello2morrow.dda.business.common.dsi.TransientDataSupplier) nextFromServerCommands)
                        .save();
            }
            else
            {
