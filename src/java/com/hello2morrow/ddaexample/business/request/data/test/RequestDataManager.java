...
public class RequestDataManager implements com.hello2morrow.ddaexample.business.request.dsi.RequestDmi
{
    ...
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert RequestDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
