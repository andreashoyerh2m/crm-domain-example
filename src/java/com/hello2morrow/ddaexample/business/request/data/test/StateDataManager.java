...
public class StateDataManager implements com.hello2morrow.ddaexample.business.request.dsi.StateDmi
{
    ...
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert StateDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
