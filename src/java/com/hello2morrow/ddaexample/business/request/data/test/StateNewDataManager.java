...
public class StateNewDataManager extends com.hello2morrow.ddaexample.business.request.data.test.StateDataManager
        implements com.hello2morrow.ddaexample.business.request.dsi.StateNewDmi
{
    public DataSupplierIf createDataSupplier(Class dataSupplierInterfaceClass, boolean isPersistent)
    {
        ...
        assert StateNewDsi.class.equals(dataSupplierInterfaceClass) : "wrong class = " + dataSupplierInterfaceClass.getName();
